...
var TopNav = function (_React$Component) {
    ...
    _createClass(TopNav, [{
        ...
        value: function render() {
            ...
            var tabs = this.props.tabNames.map(function (name, i) {

                return _react2.default.createElement(_tab2.default, { tabName: name, category: category, key: i });
            });
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!./online-grocery.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!./online-grocery.scss");
...
var _onlineGrocery = __webpack_require__(81);

var _onlineGrocery2 = _interopRequireDefault(_onlineGrocery);

var _productPage = __webpack_require__(95);
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    null,
    _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _onlineGrocery2.default }),
    _react2.default.createElement(_reactRouterDom.Route, { path: '/:category', component: _onlineGrocery2.default }),
    _react2.default.createElement(_reactRouterDom.Route, { path: '/:category/:product', component: _productPage2.default })
  )
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(9),n=__webpack_require__(13),p=__webpack_require__(5);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process, console) {/** @license React v16.1.1
...
"use strict";
/* WEBPACK VAR INJECTION */(function(console) {/** @license React v16.1.1
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(26),A=__webpack_require__(9),B=__webpack_require__(5),ca=__webpack_require__(27),da=__webpack_require__(28),ea=__webpack_require__(29),ha=__webpack_require__(30),ia=__webpack_require__(31),C=__webpack_require__(13);
...
var _productGrid = __webpack_require__(82);

var _productGrid2 = _interopRequireDefault(_productGrid);

var _topNav = __webpack_require__(39);
...
var tabNames = ['Produce', 'Deli & Dairy', 'Bread, Pasta & Rice', 'Packaged & Canned', 'Condiments, Spreads & Sauces', 'Frozen Foods', 'Beverages'];
    ...
    _createClass(HomePage, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('img', { className: 'logo-style', src: '../../src/images/SAFEWAY.png' }),
                _react2.default.createElement('img', { className: 'banner-style', src: '../../src/images/advertisement1.png' }),
                _react2.default.createElement(_topNav2.default, { tabNames: tabNames, category: this.props.category }),
...
var _productCard = __webpack_require__(86);
...
var ProductGrid = function (_React$Component) {
    ...
    _createClass(ProductGrid, [{
        key: 'render',
        value: function render() {
            var productCards = products.map(function (product, i) {
                return _react2.default.createElement(
                    'div',
                    { key: i, className: 'product-grid-item' },
                    _react2.default.createElement(_productCard2.default, product)
                );
            });
            return _react2.default.createElement(
                'div',
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-grid.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-grid.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
    ...
    _createClass(ProductCard, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('img', { className: 'product-card-image', src: this.props.src }),
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { to: link, className: 'product-card-name-small' },
                    this.props.name
                ),
                _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('img', { className: 'product-card-add-to-cart', src: '../../../src/images/trolley-clipart.png' })
                )
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-card.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-card.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "body {\n  font-family: \"Century Gothic\", sans-serif; }\n\n.product-card {\n  padding: 10%;\n  display: inline-block;\n  text-transform: capitalize; }\n  .product-card .product-card-image {\n    width: auto;\n    max-width: 100%;\n    display: block;\n    margin: auto; }\n  .product-card .product-card-name-small {\n    font-size: 18px;\n    text-decoration: none;\n    display: inline-block;\n    padding-right: 7px;\n    margin: 5px 0; }\n  .product-card .product-card-size {\n    display: inline-block;\n    font-size: 12px; }\n  .product-card .product-card-buttons {\n    display: flex;\n    justify-content: space-between; }\n    .product-card .product-card-buttons .product-card-price {\n      padding: 7px 5px;\n      color: #008800;\n      width: 50px;\n      border: 1px solid #008800;\n      text-align: center; }\n    .product-card .product-card-buttons .product-card-add-to-cart {\n      width: auto;\n      height: 25px;\n      padding: 5px 15px;\n      border: 1px solid #c301d4; }\n      .product-card .product-card-buttons .product-card-add-to-cart:hover {\n        cursor: pointer; }\n", ""]);
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            if (this.props.tabName == this.props.category) {
                return _react2.default.createElement(
                    'div',
                    { className: 'tab-container selected', onClick: this.props.selectTab },
                    _react2.default.createElement(
                        'div',
                        { className: 'tab' },
                        this.props.tabName
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./tab.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./tab.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./top-nav.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./top-nav.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".logo-style {\n  display: block;\n  width: 40%;\n  text-align: center;\n  margin: auto;\n  padding-bottom: 4px;\n  padding-top: 4px; }\n\n.banner-style {\n  display: inline-block;\n  width: 100%;\n  align-content: center; }\n", ""]);
...
var _productPage = __webpack_require__(96);
...
var ProductViewPage = function (_Component) {
    _inherits(ProductViewPage, _Component);

    function ProductViewPage() {
        _classCallCheck(this, ProductViewPage);

        return _possibleConstructorReturn(this, (ProductViewPage.__proto__ || Object.getPrototypeOf(ProductViewPage)).apply(this, arguments));
    }
    ...
    _createClass(ProductViewPage, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('img', { className: 'logo-style', src: '../../src/images/SAFEWAY.png' }),
                _react2.default.createElement('img', { className: 'banner-style', src: '../../src/images/advertisement1.png' }),
                _react2.default.createElement(_topNav2.default, { tabNames: tabNames, view: view }),
...
exports.default = ProductViewPage;
...
var _productCardExpanded = __webpack_require__(97);

var _productCardExpanded2 = _interopRequireDefault(_productCardExpanded);
        ...
        value: function render() {
            ...
            var productCards = products.map(function (product) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_productCardExpanded2.default, product)
                );
            });
            return _react2.default.createElement(
                'div',
...
var ProductCardExpanded = function (_React$Component) {
    _inherits(ProductCardExpanded, _React$Component);

    function ProductCardExpanded() {
        _classCallCheck(this, ProductCardExpanded);

        return _possibleConstructorReturn(this, (ProductCardExpanded.__proto__ || Object.getPrototypeOf(ProductCardExpanded)).apply(this, arguments));
    }

    _createClass(ProductCardExpanded, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'product-card' },
                _react2.default.createElement('img', { className: 'product-card-image-large', src: this.props.src }),
                _react2.default.createElement(
                    'div',
...
exports.default = ProductCardExpanded;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-card-expanded.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./product-card-expanded.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "body {\n  font-family: \"Century Gothic\", sans-serif; }\n\n.product-card {\n  padding: 10%;\n  display: inline-block;\n  text-transform: capitalize; }\n  .product-card .product-card-image-large {\n    width: auto;\n    max-width: 70%;\n    display: block;\n    margin: auto; }\n  .product-card .product-card-name {\n    font-size: 40px;\n    display: inline-block;\n    padding-right: 7px;\n    margin: 5px 0; }\n  .product-card .product-card-description {\n    font-size: 14px;\n    display: inline-block;\n    padding-right: 7px;\n    margin: 5px 0; }\n  .product-card .product-card-size {\n    display: inline-block;\n    font-size: 12px; }\n  .product-card .product-card-buttons {\n    display: flex;\n    justify-content: space-between; }\n    .product-card .product-card-buttons .product-card-price {\n      padding: 7px 5px;\n      color: #008800;\n      width: 50px;\n      border: 1px solid #008800;\n      text-align: center; }\n    .product-card .product-card-buttons .product-card-add-to-cart {\n      width: auto;\n      height: 25px;\n      padding: 5px 15px;\n      border: 1px solid #c301d4; }\n      .product-card .product-card-buttons .product-card-add-to-cart:hover {\n        cursor: pointer; }\n    .product-card .product-card-buttons .product-card-quantity-button {\n      width: auto;\n      height: 25px;\n      padding: 5px 15px;\n      border: 1px solid deepskyblue; }\n      .product-card .product-card-buttons .product-card-quantity-button:hover {\n        cursor: pointer; }\n", ""]);
